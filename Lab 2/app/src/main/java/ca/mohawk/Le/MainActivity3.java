...
public class MainActivity3 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    final static String tag = "==Activity Three==";
    final static String curr = "From Third Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mySpinner.setSelection(2, false);
        mySpinner.setOnItemSelectedListener(this);

        TextView nameOutput = findViewById(R.id.name3);
        nameOutput.setText("");
        TextView activityOutput = findViewById(R.id.from3);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (position == 0) {
            Intent switchActivity = new Intent(MainActivity3.this, MainActivity.class);
            switchActivity.putExtra("loginText", name);
            switchActivity.putExtra("activity", curr);
            startActivity(switchActivity);
        } else if (position == 1) {
            Intent switchActivity = new Intent(MainActivity3.this, MainActivity2.class);
            switchActivity.putExtra("loginText", name);
            switchActivity.putExtra("activity", curr);
            startActivity(switchActivity);
        }
